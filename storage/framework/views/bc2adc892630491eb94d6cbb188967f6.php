...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border mb-4">
        <div class="card-body">
            <form method="get" action="<?php echo e(route('events.history')); ?>" class="row g-3 align-items-end">
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <input type="text" name="search" id="search" class="form-control form-control-sm"
                        ...
                        value="<?php echo e(old('search', $filters['search'] ?? '')); ?>">
                </div>
                <div class="col-12 col-md-6 col-lg-2">
                    ...
                    <input type="date" name="event_date" id="event_date" class="form-control form-control-sm"
                        value="<?php echo e(old('event_date', $filters['event_date'] ?? '')); ?>">
                </div>
                <div class="col-12 col-md-6 col-lg-2">
                ...
                <div class="col-12 col-md-6 col-lg-2">
                    ...
                    <select name="department" id="department" class="form-select form-select-sm">
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dept); ?>" <?php echo e(($filters['department'] ?? '') === $dept ? 'selected' : ''); ?>><?php echo e($dept); ?></option>
                ...
                <?php if(($filters['search'] ?? '') !== '' || ($filters['event_date'] ?? '') !== '' || ($filters['status'] ?? '') !== '' || ($filters['department'] ?? '') !== ''): ?>
                <div class="col-12 col-lg-1">
                    <a href="<?php echo e(route('events.history')); ?>" class="btn btn-secondary btn-sm w-100">Clear</a>
                </div>
                <?php endif; ?>
            </form>
        </div>
                ...
                <div class="card h-100 shadow-sm border">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge
                                <?php if($entry->status === 'approved'): ?> bg-success
                                <?php elseif($entry->status === 'pending'): ?> bg-warning text-dark
                                <?php else: ?> bg-danger
                                <?php endif; ?>">
                        ...
                        <small class="text-muted d-block mb-2">Ref #<?php echo e($entry->event_id ?? 'N/A'); ?></small>

                        <ul class="list-unstyled small mb-0">
                            <li class="mb-1">
                                <i class="fas fa-calendar-day text-muted me-2" style="width: 1.25rem;"></i>
                                <strong>Date:</strong> <?php echo e(optional($entry->event_date)->format('M d, Y') ?? '—'); ?>

                            </li>
                            <?php if($timeStr): ?>
                            <li class="mb-1">
                                <i class="fas fa-clock text-muted me-2" style="width: 1.25rem;"></i>
                                <strong>Time:</strong> <?php echo e($timeStr); ?>
                            ...
                            <li class="mb-1">
                                ...
                                <strong>Created by:</strong> <?php echo e($creatorName ?? '—'); ?>
                        ...
                        <div class="mt-3 pt-2 border-top">
                            <button class="btn btn-sm btn-secondary w-100" type="button"
                                data-bs-toggle="collapse" data-bs-target="#historyLog<?php echo e($entryId); ?>"
                                aria-expanded="false" aria-controls="historyLog<?php echo e($entryId); ?>">
                                <i class="fas fa-chevron-down me-1"></i> Show History
                            </button>
                            <div class="collapse mt-2" id="historyLog<?php echo e($entryId); ?>">
                                <div class="small bg-light rounded p-2">
                                    <div class="d-flex flex-wrap align-items-center gap-1">
                                        <?php if($entry->action === 'approved'): ?>
                                            <i class="fas fa-check-circle text-success me-2"></i>
                                        <?php elseif($entry->action === 'rejected'): ?>
                                            <i class="fas fa-times-circle text-danger me-2"></i>
                                        <?php elseif($entry->action === 'deleted'): ?>
                                            <i class="fas fa-trash-alt text-secondary me-2"></i>
                                        <?php elseif($entry->action === 'submitted'): ?>
                                            <i class="fas fa-paper-plane text-info me-2"></i>
                                        <?php else: ?>
                                            <i class="fas fa-plus-circle text-primary me-2"></i>
                                        <?php endif; ?>
                                        <span class="text-capitalize"><?php echo e(str_replace('_', ' ', $entry->action)); ?></span>
                                        <span class="text-muted">by <?php echo e($performerName); ?></span>
                                        <span class="text-muted">on <?php echo e(optional($entry->performed_at)->format('M d, Y \a\t g:i A') ?? '—'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\OneDrive\Desktop\Scheduling and Inventory System\resources\views/events/history.blade.php ENDPATH**/ ?>