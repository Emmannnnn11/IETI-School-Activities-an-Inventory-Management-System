...
<head>
    ...
    <title><?php echo e(config('app.name', 'IETI School Activities Scheduling and Inventory Management System')); ?></title>
    ...
    <style>
        ...
        body {
            ...
            background-image: url("<?php echo e(asset('IETI-background.png')); ?>");
    ...
    <div id="app">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/home')); ?>">
             <img src="<?php echo e(asset('logo.jpg')); ?>" alt="IETI Logo" class="me-2">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                ...
                                <span class="badge bg-secondary ms-1"><?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->role))); ?></span>
                            </a>
                ...
                <div class="sidebar-wrapper" id="sidebarWrapper">
                    <div class="sidebar" id="sidebar">
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link <?php echo e(request()->routeIs('events.history') ? 'active' : ''); ?>" href="<?php echo e(route('events.history')); ?>">
                                <i class="fas fa-history me-2"></i> Event History
                            </a>
                            <?php endif; ?>
                            <?php if(Auth::user()->canCreateEvents()): ?>
                            <a class="nav-link <?php echo e(request()->routeIs('events.create') ? 'active' : ''); ?>" href="<?php echo e(route('events.create')); ?>">
...
<?php /**PATH C:\Users\Administrator\OneDrive\Desktop\Scheduling and Inventory System\resources\views/layouts/app.blade.php ENDPATH**/ ?>