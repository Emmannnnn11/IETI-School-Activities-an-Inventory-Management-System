...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'IETI School Activities Scheduling and Inventory Management System')); ?></title>
    ...
    <style>
        ...
        .login-split-left::before {
            ...
            position: absolute;
            inset: -20px;
            background: url('<?php echo e(asset('IETI-background.png')); ?>') center / cover no-repeat;
            filter: blur(3px);
            pointer-events: none;
            z-index: 0;
        }
            ...
            <div class="login-split-left">
                <div class="split-left-top">
                    <div class="split-logo-wrap">
                        <img src="<?php echo e(asset('logo.jpg')); ?>" alt="IETI Logo">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('password.request')); ?>" class="link-forgot">
                            Forgot Password?
                        </a>
                    </div>
                </form>
...
<?php /**PATH C:\Users\Administrator\OneDrive\Desktop\Scheduling and Inventory System\resources\views/auth/login.blade.php ENDPATH**/ ?>